...
function openBox(boxId) {
    ...
    document.getElementById("codigoUnico").textContent = generarCodigoUnico();
    document.getElementById("fechaHora").textContent = obtenerFechaHoraActual();
...
function getRandomPrize() {
    ...
    const prizeWeights = {
        ...
        'manzanabox_2x1': 5,
        'pepinos_extra': 10,
        'no_prize': 60  // Mayor probabilidad de no ganar
    };
